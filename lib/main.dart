...
const keyApplicationId = 'yinmZvTU8J2bKQ6GyNRh1dwiJlHHWYnqiVjDcV1x';
const keyClientKey = 'Lt1qBFKFf6TUO0gn2GazOloE7gx54igB9OuWpY4p';
const keyParseServerUrl = 'https://parseapi.back4app.com';

await Parse().initialize(keyApplicationId, keyParseServerUrl,
clientKey: keyClientKey, debug: true);

var firstObject = ParseObject('B4aVehicle')
      ..set(
